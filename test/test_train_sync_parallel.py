...
if __name__ == "__main__":
    ...
    from core.train import train_sync_parallel
    ...
    args = parse_args([
        ...
        '--num_cpus', '128', '--num_gpus', '1', '--train_on_gpu',
        '--data_actors', '1', '--num_pmcts', '1', '--reanalyze_actors', '10',
    ...
    if args.reanalyze_actors > 1:
        ray.init(num_gpus=args.num_gpus, num_cpus=args.num_cpus, object_store_memory=20 * 1024 * 1024 * 1024)
