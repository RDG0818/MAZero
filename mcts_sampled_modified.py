    ...
    def batch_search(
        ...
        with torch.no_grad():
            ...
            for index_simulation in range(self.config.num_simulations):
                ...
                with autocast():
                    prior_network_output = model.initial_inference(batch_hidden_states) # For agents i+1, i+2, ... N actions

                batch_policy_logits_prior = prior_network_output.policy_logits
